	...
	renderTrackingMeta () {
			...
			if (data.createdBy) {
				...
				elements.push(
					<FormField key="createdBy" label="Criado por">
						<FormInput noedit>{data.createdBy.email}</FormInput>
					</FormField>
				);
			}
		}
		...
		if (this.props.list.tracking.updatedAt) {
			...
			if (data.updatedAt && (!data.createdAt || data.createdAt !== data.updatedAt)) {
				elements.push(
					<FormField key="updatedAt" label="Alterado em">
		...
		if (this.props.list.tracking.updatedBy) {
			...
			if (data.updatedBy && (!data.createdBy || data.createdBy.id !== data.updatedBy.id || elements.updatedAt)) {
				elements.push(
					<FormField key="updatedBy" label="Alterado por">
						<FormInput noedit>{data.updatedByemail}</FormInput>
					</FormField>
				);
			}
		}
